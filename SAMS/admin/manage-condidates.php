                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {   ?>
                                                    <tr>
                                                        ...
                                                        <td><img src="<?php echo $result->photo; ?>" alt="student" width="40px" height="40px" class="img-circle"></td>
                                                        ...
                                                        <td > 
                                                        <a href="edit-condidate.php?condidate=<?php echo htmlentities($result->condidate_id); ?>&assignment=<?php echo htmlentities($result->assignment_id); ?>&election=<?php echo htmlentities($result->election_round); ?>"><i class="fa fa-edit text-info" title="Edit Record"></i> </a>
                                                          
                                                        </td>
                                                        <td > 
                                                          
                                                            <a href="delete-condidate.php?condidate=<?php echo htmlentities($result->condidate_id); ?>&assignment=<?php echo htmlentities($result->assignment_id); ?>&election=<?php echo htmlentities($result->election_round); ?>" class="delete" ><i class="fa fa-trash text-danger ml-1" title="Delete Record"></i> </a>
                                                        </td>
