...
if (isset($_POST['date'])) {
    ...
    $sql = "INSERT INTO `subject_class` (`class_name`, `department`, `subject_code`, `status`, `creation_date`) VALUES 
    (:classname, :department, :subject_code, 1, :date)";

    $query = $dbh->prepare($sql);
    $query->bindParam(':classname', $class, PDO::PARAM_STR);
...
<div class="main-page">
    <div class="container-fluid">
        <div class="row page-title-div">
            <div class="col-md-6">
                <h2 class="title">Create Class-Subject Combination</h2>
            </div>
        ...
        <div class="row breadcrumb-div">
            <div class="col-md-6">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Create Class-Subject Combination</li>
                </ul>
            </div>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <h5>Create Class-Subject Combination</h5>
                            </div>
                        </div>
                        <?php if ($msg) { ?>
