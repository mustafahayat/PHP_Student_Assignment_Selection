...
if (isset($_POST['login'])) {
    ...
    if ($query->rowCount() > 0) {
        ...
        echo "<script>document.location = 'index.php?error=field'</script>";
    }
}
...
<body class="">
 ...
 <?php
         if(isset($_GET['error'])){
             echo "<div class='text-danger'><strong>Field:</strong> Invalid Username Or  Password! Please Try Again!!</div>";
    ...
    ?>
                                        ...
                                        <!-- /.panel -->
                                        <p class="text-muted text-center"><small>Copyright © SAMS</small></p>
                                    </div>
                                    <!-- /.col-md-11 -->
                                </div>
                                <!-- /.row -->
