                                    ...
                                    <table id="example" class="display table table-striped table-responsive table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>       
                                            <?php 
                                                ...
                                                $sql = "SELECT main.*, assigned_assignments.*, students.fullname, subjects.subject_name FROM done_assignments as main
                                                INNER JOIN assigned_assignments ON main.assignment_id = assigned_assignments.assignment_id
                                                INNER JOIN students ON main.student_rollno = students.student_rollno
                                                INNER JOIN subjects ON assigned_assignments.subject_code = subjects.subject_code";
