                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {   ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit-class.php?class=<?php echo htmlentities($result->class_name); ?>&department=<?php echo htmlentities($result->department); ?>"><i class="fa fa-edit" title="Edit Record"></i> </a>
                                                        </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
                                                }
