<?php 
    ...
    $sql = "SELECT  fullname, photo FROM students WHERE student_rollno = :rollno";
    $statment = $dbh->prepare($sql);
    $statment->bindParam(':rollno', $_SESSION['slogin'], PDO::PARAM_STR);
...
<div class="left-sidebar bg-black-300 box-shadow ">
    <div class="sidebar-content">
        <div class="user-info closed">
           <?php
            $photo = ltrim($results['photo'], "../"); 
           ?>
           
            <img src="<?php echo $photo; ?>" alt="<?php echo $results['fullname'] ?>" class="img-circle profile-img" width="50px" height="50px">
            <h6 class="title"><?php echo $results['fullname'] ?></h6>
            <small class="info"><?php echo "System Students" ?> </small>
        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li class="">
                    <a href="manage-class.php"><i class="fa fa-school"></i> <span>Classes</span></a>
                    <!-- <ul class="child-nav">
                ...
                <li class="has-children">
                    ...
                    <ul class="child-nav">
                        ...
                        <li><a href="manage-subjects.php"><i class="fa fa fa-book"></i> <span>All Subjects</span></a></li>
                        <!-- <li><a href="add-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span>Add Subject Combination </span></a></li> -->
                        <a href="manage-subjectcombination.php"><i class="fa fa-newspaper-o"></i> <span> Subject-Class Combination </span></a>
                <!-- </li> -->
                </ul>
            </li>
            <li class="">
                <a href="manage-students.php"><i class="fa fa-users"></i> <span>Students</span></a>
                <!-- <ul class="child-nav">
            ...
            <li class="">
                <a href="give-vote.php"><i class="fa fa-vote-yea"></i> <span>Give Vote</span> </a>
                <!-- <ul class="child-nav">
            ...
            <!-- The Following Modal Code is Placed in THe bottomfooter -->
                ...
                <!-- The Following Modal Code is Placed in THe bottomfooter -->
            <li><a href="#password" data-toggle="modal"><i class="fa fa fa-edit"></i> <span> Change Your Password</span></a></li>
